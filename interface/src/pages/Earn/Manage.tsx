    ...
    <PageWrapper gap="lg" justify="center">
      ...
      {showAddLiquidityButton && (
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>Step 1. Get MANGO Liquidity tokens</TYPE.white>
              </RowBetween>
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
        ...
        {!userLiquidityUnstaked ? null : userLiquidityUnstaked.equalTo('0') ? null : !stakingInfo?.active ? null : (
          <TYPE.main>{userLiquidityUnstaked.toSignificant(6)} MANGO LP tokens available</TYPE.main>
        )}
      </PositionInfo>
    </PageWrapper>
  )
